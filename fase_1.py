...
def gerar_obstaculos_fase_1(
        grupo_obstaculos: pygame.sprite.Group, velocidade: int
) -> None:
    """
    ...
    """
    tipo = random.choice(["tronco", "galho"])  # Escolhe aleatoriamente entre os tipos
    ...
    obstaculo.hitbox.topleft = (obstaculo.rect.x, obstaculo.rect.y + 10)  # Desce hitbox
